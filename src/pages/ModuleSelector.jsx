...
const CREDITS_LINES = [
  ...
  '    Internship — Permitting & Detailed Design HV',
  '    Enel Colombia, 2026-1',
  '',
  '  [ USUARIOS DEL SISTEMA ]',
  '    Equipos transversales Enel Colombia',
  '    Jurídico, Ambiental, Permisos, Diseño HV',
  '',
  ':: STACK TECNOLÓGICO ::',
  '',
  '  ✦  PostgreSQL + pgvector',
  ...
  ':: AGRADECIMIENTOS ::',
  '',
  '  A todos los equipos que confiaron en este sistema.',
