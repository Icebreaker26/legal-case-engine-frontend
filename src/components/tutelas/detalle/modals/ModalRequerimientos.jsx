...
export function ModalCrearRequerimiento({
    ...
    const [nuevoReq, setNuevoReq] = useState({ grupo_id: '', descripcion: '' });
    ...
    const handleCrearReq = async (e) => {
        ...
        setUpdating(true);
        try {
            const payload = { ...nuevoReq, grupo_id: parseInt(nuevoReq.grupo_id) };
            ...
            setNuevoReq({ grupo_id: '', descripcion: '' });
            setBusquedaArea('');
            ...
            <div className="bg-white rounded-3xl w-full max-w-md p-8 shadow-2xl animate-scale-in border border-gray-100">
                ...
                <form onSubmit={handleCrearReq} className="space-y-6">
                    <div className="relative">
                        <label className="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-2 block">Área Destino</label>
                        <div 
                        ...
                        >
                            <span className={nuevoReq.grupo_id ? "text-gray-800" : "text-gray-400"}>
                                {nuevoReq.grupo_id ? areasDinamicas.find(a => a.id == nuevoReq.grupo_id)?.nombre : 'Selecciona un área...'}
                            </span>
                        </div>
                        {isOpenDropdown && (
