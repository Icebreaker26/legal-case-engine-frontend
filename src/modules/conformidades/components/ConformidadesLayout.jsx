...
export default function ConformidadesLayout() {
  ...
  return (
    <ProtectedRoute>
      <div className="conformidades-layout bg-[#2c2c2c] min-h-screen font-mono text-[#1a1a1a] relative overflow-hidden">
        ...
        <header className="bg-[#e0dcc8] border-b-4 border-double border-[#2d4a3e] p-4 flex justify-between items-center relative z-50">
            <h1 className="text-xl font-bold uppercase tracking-[0.2em] text-[#2d4a3e]">Módulo de Conformidades</h1>
