                    ...
                    <div className="p-2 border-b border-gray-100">
                        <div className="relative">
                            ...
                            <input
                                ref={inputRef}
                                type="text"
                                className="w-full pl-8 pr-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-600 focus:bg-white transition-all placeholder:text-gray-400"
                                placeholder="Buscar..."
                                value={query}
